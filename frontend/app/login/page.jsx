  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple/40 via-pink/50 to-coral/40 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-electric-violet/30 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-coral-vibrant/30 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink/20 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 bg-white">
              <div className="mb-8">
                ...
                <h2 className="text-4xl font-display font-bold text-gray-800">Log In</h2>
              </div>
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/signup" className="text-coral-vibrant font-semibold hover:underline">
                    Sign up
                  </Link>
                </p>
              </div>
            ...
            <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-blue/20 to-lavender/30 p-12 relative overflow-hidden">
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-10 right-10 w-32 h-32 bg-coral-vibrant rounded-full blur-3xl"></div>
                <div className="absolute bottom-10 left-10 w-40 h-40 bg-electric-violet rounded-full blur-3xl"></div>
              </div>
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <div className="w-48 h-48 mx-auto bg-gradient-to-br from-coral-vibrant/20 to-electric-violet/20 rounded-full flex items-center justify-center">
                    <Sparkles className="text-coral-vibrant" size={80} />
                  </div>
                </motion.div>
                ...
                <p className="text-gray-600 max-w-sm mx-auto">
                  Continue your interview preparation journey and ace your next opportunity
                </p>
              </div>
            </div>
          </div>
